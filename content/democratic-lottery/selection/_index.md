---
title: The selection
description: What is a selection?
weight: 20
---
...
Sortition Foundation uses bespoke open source software to do the selection in a special way:
 1. It is **random** -- a person is selected using random chance.
 2. It is **stratified** -- we use targets to ensure that the 50 people we select are representative of the population from which they are drawn.
 3. It is **fair** -- everyone in the pool has as much chance as possible to be selected, given the existence of targets.
