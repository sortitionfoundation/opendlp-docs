---
title: Targets - when and how
description: When and how do we set targets?
weight: 10
---
...
| Gender | Census | Number  | Minimum | Maximum|
|--------|:------------:|:----------------:|:---------:|:--------:|
| Female | 49% | 24.5 | 24 | 25 |
| Male   | 48% | 24 | 24 | 25 |
| Non-binary or other | 3% | 1.5 | 1 | 2 |
...
The complexity consideration also explains why we don't do targets for *intersections* of different features: we have targets for *gender* and targets for *age* but we don't have targets for the combination (e.g. the number of females aged 15-24) because we quickly end up with too much impossible mathematics.
