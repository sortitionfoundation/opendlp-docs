...
In the UK, Australia, the US, Ireland and in several other countries, our preferred method is to send invitations by post. We use bespoke software to select addresses from national databases of postal addresses. E.g. in the UK we use the [PAF](https://www.poweredbypaf.com/).
...
By experience we know that we tend to get a lower response rate from people living in more deprived areas. As a result, in the UK our default is to weight our random selection so that more addresses go to houses with [IMD scores 1 to 3](https://www.gov.uk/government/statistics/english-indices-of-deprivation-2025/english-indices-of-deprivation-2025-statistical-release).
